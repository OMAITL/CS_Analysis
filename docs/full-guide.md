...
> **本仓库以 CS 饰品分析为主。** 饰品相关文档请阅读 [CS 使用与配置指南](cs-guide.md)、[文档中心](INDEX.md) 与 [README](../README.md)。  
> 下文内容为上游 **A 股 / 港股 / 美股** 自选股分析配置，仅在使用 `/stocks`、定时股票任务或股票推送时需要。

本文档包含股票智能分析系统的完整配置说明，适合需要高级功能或特殊部署方式的用户。
