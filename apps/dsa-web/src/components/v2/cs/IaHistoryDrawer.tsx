...
export const IaHistoryDrawer: React.FC<IaHistoryDrawerProps> = ({
  ...
  <>
    ...
    >
      ...
      <span className="hidden sm:inline">历史分析</span>
    ...
    <aside className={`ia-history-panel ${open ? 'ia-history-panel-open' : ''}`}>
      <div className="ia-history-panel-head">
        <h2>历史分析</h2>
      ...
      <div className="ia-history-panel-body">
        {items.length === 0 ? (
