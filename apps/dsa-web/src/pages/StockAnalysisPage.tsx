...
const StockAnalysisPage: React.FC = () => {
  ...
  return (
    <div
      data-testid="stock-dashboard"
      className="flex min-h-0 flex-1 flex-col overflow-hidden"
    >
      <div className="flex min-h-0 min-w-0 w-full max-w-full flex-1 flex-col mx-auto lg:max-w-6xl">
        ...
        <div className="flex-1 flex min-h-0 overflow-hidden">
          ...
          <section
            ...
            data-testid="stock-dashboard-scroll"
