...
describe('StockAnalysisPage', () => {
  ...
  it('renders the dashboard workspace and auto-loads the first report', async () => {
    ...
    const dashboard = await screen.findByTestId('stock-dashboard');
    ...
    expect(screen.getByTestId('stock-dashboard-scroll')).toBeInTheDocument();
  ...
  it('scrolls the dashboard to market review feedback after toolbar clicks', async () => {
    ...
    const dashboardScroll = screen.getByTestId('stock-dashboard-scroll');
