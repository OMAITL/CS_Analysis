...
"""
    ...
    def analyze(
        ...
        if context.get("asset_type") == "cs_item" or context.get("is_cs_item"):
            from src.services.cs_analysis_report import get_cs_analysis_system_prompt

            system_prompt = get_cs_analysis_system_prompt(self, report_language)
        else:
    ...
    def _format_prompt(
        ...
        if context.get("asset_type") == "cs_item" or context.get("is_cs_item"):
            from src.services.cs_analysis_report import format_cs_analyzer_user_prompt

            return format_cs_analyzer_user_prompt(
                context,
                name,
                news_context,
                report_language=report_language,
